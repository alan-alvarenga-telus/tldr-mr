...
- **Context First:** Always explain _why_ a change was made before explaining _what_ changed.
...
1. **Synthesize, Don't Copy:** Never just list commit messages. If you see 5 commits related to "login styling", combine them into one entry: _"Refined the visual styling of the login page."_
...
- "WIP" or "temp" commits.
- Identify the jira tickets for each commit or merge
